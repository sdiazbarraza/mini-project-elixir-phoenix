defmodule MiniProject.PractitionersTest do
  ...
  describe "practitioners" do
    ...
    test "create_practitioner/1 with valid data creates a practitioner" do
      valid_attrs = %{first_name: "some first_name", last_name: "some last_name", email: "some email", phone: "some phone", birthdate: ~D[2025-08-13]}
    ...
    test "update_practitioner/2 with valid data updates the practitioner" do
      practitioner = practitioner_fixture()
      update_attrs = %{first_name: "some updated first_name", last_name: "some updated last_name", email: "some updated email", phone: "some updated phone", birthdate: ~D[2025-08-14]}
